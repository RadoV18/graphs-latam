...
//     operateInMatrix(copyMatrix, maximaze, verdaderasSoluciones, matrixSolutions);
...
// function minimizarFunction(copyMatrix, maximaze, trueSoutions, matrixSolutions){
...
// function operateWithPivote(matrixSelected, elementsInColumn, elementsInRow, num){
//     for(let i = 0 ; i < matrixSelected.length ; i++){
//         for(let j = 0 ; j < matrixSelected[i].length ; j++){

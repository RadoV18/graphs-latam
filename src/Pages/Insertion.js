...
import { arregloRandomico, convertirArregloNumeros, execTimeInsertionSort } from "../utils/algorithms/sortTime";

const Insertion = ({ complexity, animation }) => {
    ...
    const sort = () => {
        ...
        const resultObject = execTimeInsertionSort(newInput);
